...
X <- as.matrix(cbind(1, all_data[,c(3,5)]))      # pollution + overfishing
...
uB = c(0,0,0)                 # mean vector in the Gaussian prior of beta
VB = diag(c(1,1,1))                      # covariance matrix in the Gaussian prior of beta
...
load(file = "F:/Project/Code/R/Correction/rg_fullmodel_east.rda")
load(file = "F:/Project/Code/R/Correction/rg_fullmodel_west.rda")
load(file = "F:/Project/Code/R/Correction/rs_fullmodel_east.rda")
load(file = "F:/Project/Code/R/Correction/rs_fullmodel_west.rda")

launch_shinystan(rg_fullmodel_east)
launch_shinystan(rg_fullmodel_west)
launch_shinystan(rs_fullmodel_east)
launch_shinystan(rs_fullmodel_west)
